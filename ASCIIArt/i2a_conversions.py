...
def convert_image_to_ascii(filepath):
    command = f"~/go/bin/image2ascii -f {filepath} -c=false -g 80 -w 80"
...
if __name__ == "__main__":
    ...
    convert_images("train.json", "train_i2a_conversions.json")
    convert_images("val.json", "val_i2a_conversions.json")
